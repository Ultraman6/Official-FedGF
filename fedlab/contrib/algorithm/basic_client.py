...
class SGDClientTrainer(ClientTrainer):
    ...
    def setup_optim(self, epochs, batch_size, lr, weight_decay, momentum):
        ...
        self.optimizer = torch.optim.SGD(self._model.parameters(), lr=lr, weight_decay=weight_decay, momentum=momentum)
...
class SGDSerialClientTrainer(SerialClientTrainer):
    ...
    """
    def __init__(self, model, num_clients, cuda=True, device=None, logger=None, personal=False) -> None:
