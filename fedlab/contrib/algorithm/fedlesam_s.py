...
from .minimizers import SAM, LESAM, LESAM_S
...
class FedLESAMSServerHandler(FedAvgServerHandler):
    pass
...
class FedLESAMSSerialClientTrainer(SGDSerialClientTrainer):
    ...
    def train(self, id, model_parameters, train_loader):
        ...
        optimizer = LESAM_S(self.model.parameters(), self.optimizer, rho=self.rho)
